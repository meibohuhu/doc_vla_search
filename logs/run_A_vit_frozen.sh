#!/bin/bash
# Ablation A: ViT FROZEN + LLM full-param  (original AutoVLA recipe / baseline)
# Pair with run_B_vit_unfreeze.sh -- identical except train_vision_backbone.
#
#   Usage:  bash logs/run_A_vit_frozen.sh
#
set -u
CONFIG="training/qwen2.5-vl-3B-nuplan-nocot-sft"
TAG="A_vit_frozen"
...
echo "=================================================================="
echo " run    : $TAG  (ViT frozen, LLM full-param)"
